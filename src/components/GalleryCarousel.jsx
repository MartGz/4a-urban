    ...
    <div className="overflow-hidden py-2">
      <div className="animate-marquee" style={{ animationDuration: `${duration}s` }}>
        {loop.map((img, i) => (
          <div
            key={`${img.id}-${i}`}
            className="w-52 h-52 sm:w-60 sm:h-60 shrink-0 rounded-[24px] overflow-hidden border border-white/10 relative group mx-2 bg-[#18181b]/40"
          >
            <img
            ...
            />
            {img.caption && (
              <div className="absolute inset-0 bg-gradient-to-t from-[#18181b]/80 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity flex items-end p-4">
